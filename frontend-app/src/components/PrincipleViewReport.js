...
const PrincipleViewReport = () => {
    ...
    const MarkAsSeenReport = async () => {
        try {
            await axios.put(`${API_BASE_URL}/reports/principle-view-reports/${id}`, {
                subjects: report.subjects,
                seenByPrincipal: true
            });

            setSuccessMessage('Report marked as seen successfully!');
            setTimeout(() => {
                navigate('/principleDashboard', { state: { selectedOption: 'pri-view-report' } });
        ...
        <div className="report-container">
            ...
            <div className="d-flex justify-content-start mt-4" style={{ paddingBottom: '70px' }}>
                <div className="button-container">
                    ...
                    <button className="btn save-btn" onClick={MarkAsSeenReport}>Mark as seen</button>
                </div>
...
export default PrincipleViewReport;