...
const Dashboard = () => {
    ...
    const [selectedOption, setSelectedOption] = useState(sessionStorage.getItem('selectedOption') || 'pri-view-report');
    ...
    const handlePrincipleViewReport = (report) => {
        navigate(`/principle-view-report/${report._id}`);
    };
            ...
            <div className="row flex-nowrap" style={{ paddingTop: '130px' }}>
                ...
                >
                    <div className="nav flex-column nav-pills mt-4" style={{ paddingTop: '8px', minHeight: 'calc(100vh - 100px)', boxSizing: 'border-box' }}>
                        <button
                            className={`btn-nav ${selectedOption === 'pri-view-report' ? 'active' : ''}`}
                            onClick={() => setSelectedOption('pri-view-report')}
                        >
                            View Reports
                        </button>
                        <button
                ...
                {errorMessage && <div className="alert alert-danger">{errorMessage}</div>}
                    {selectedOption === 'pri-view-report' && (
                                                ...
                                                {report.studentId ? (
                                                    <>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => handlePrincipleViewReport(report)}
                                                        >
                                                            View Report
                                                        </button>
                                                    </>
